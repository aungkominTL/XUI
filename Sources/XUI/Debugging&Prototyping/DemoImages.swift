...
public struct DemoImages {
    ...
    public static let demoPhotosURLs = [
        URL(string: "https://pic2.99.co/v3/TgHWJbmFbosLvcpBaomWCH?text=Darren+Ong+KY&sampling=lanczos&version=1&height=600&width=800&mode=fill&quality=80&convert_if_png=true&signature=b407e18e21efddafcfaddd44dd4dc54e1a22099a")!,
        URL(string: "https://pic2.99.co/v3/9XraDD3ycymnqXHgRE2ZLc?text=Darren+Ong+KY&sampling=lanczos&version=1&height=600&width=800&mode=fill&quality=80&convert_if_png=true&signature=04ebce368c9dfbe5124c6cdcf677315c2b14f871")!,
        URL(string: "https://pic2.99.co/v3/vJAmibyZqaJi8YB6BvDe56?text=SALLY+Lum&sampling=lanczos&version=1&height=600&width=800&mode=fill&quality=80&convert_if_png=true&signature=117a2f8ff5426d6031cc0238bb9abfdb89a62557")!,
        URL(string: "https://pic2.99.co/v3/RC4xJ8FYJRrayAtfSmkNGk?text=SALLY+Lum&sampling=lanczos&version=1&height=600&width=800&mode=fill&quality=80&convert_if_png=true&signature=1d0387343d2a3517821a59a398ae1dcaa68bb0df")!,
        URL(string: "https://pic2.99.co/v3/6oJNE5wbJ6qzWw53putYGS?text=Ella+Chong&sampling=lanczos&version=1&height=600&width=800&mode=fill&quality=80&convert_if_png=true&signature=005a0f0b55c03e693b37cf2b89bd9446b4a3e3a3")!,
        URL(string: "https://pic2.99.co/v3/M5PwbUtUQDaoMShc424bm2?text=Ella+Chong&sampling=lanczos&version=1&height=600&width=800&mode=fill&quality=80&convert_if_png=true&signature=734537f3c9e1be75a95fa60514f492611017498a")!,
        URL(string: "https://pic2.99.co/v3/zKNA7dmLm4Eo2iScggZXHD?text=Ella+Chong&sampling=lanczos&version=1&height=600&width=800&mode=fill&quality=80&convert_if_png=true&signature=c7473a20eabb9d1fa5e68d340e612a2e07fd9539")!,
        URL(string: "https://pic2.99.co/v3/AS8mr3q22noHy4qniMUb9P?text=Caroline+Ong&sampling=lanczos&version=1&height=600&width=800&mode=fill&quality=80&convert_if_png=true&signature=ba76309b0c3832c6d4b4f5c9188d1b24332aacb1")!,
        URL(string: "https://pic2.99.co/v3/ii7hLoZPJ7jqG3YvW5UTtm?text=Lim+Keene&sampling=lanczos&version=1&height=600&width=800&mode=fill&quality=80&convert_if_png=true&signature=7138f83ef9f3b54ad844a5ece02c84de77a35f7e")!,
        URL(string: "https://pic2.99.co/v3/iHMSXX2zqtTXMVerAPcVsF?text=Lim+Keene&sampling=lanczos&version=1&height=600&width=800&mode=fill&quality=80&convert_if_png=true&signature=47eecd44cd7fce1bd31cf8455ae2097d04e34019")!,
        URL(string: "https://pic2.99.co/v3/jVo45g69f2V7dhThetLK6C?text=Lim+Keene&sampling=lanczos&version=1&height=600&width=800&mode=fill&quality=80&convert_if_png=true&signature=b8ab1ea8cd3bc6cc705c3f3819c1547be0d3a6f8")!,
        URL(string: "https://pic2.99.co/v3/i8mGoD5QgqGLkeVQohV52Z?text=Lim+Keene&sampling=lanczos&version=1&height=600&width=800&mode=fill&quality=80&convert_if_png=true&signature=2e33400c82e5542e53e5b8ea1340c773f02129f5")!,
        URL(string: "https://pic2.99.co/v3/hfsJPyoGqvLwm3b4KWH8U9?text=Vicole+Lim&sampling=lanczos&version=1&height=600&width=800&mode=fill&quality=80&convert_if_png=true&signature=fa744f152afeebb56b1e1a9018c97e0329eedc7b")!,
        URL(string: "https://pic2.99.co/v3/LorLbZC2bkJorr7v5BV8GC?text=Vicole+Lim&sampling=lanczos&version=1&height=600&width=800&mode=fill&quality=80&convert_if_png=true&signature=01e020469fface1f1e20c2ed5713994ef415cc04")!,
        URL(string: "https://pic2.99.co/v3/hyZoFatYUwr3ZLbKPT598G?text=Susan+Wee&sampling=lanczos&version=1&height=600&width=800&mode=fill&quality=80&convert_if_png=true&signature=1c394e367b0698a69b8d1b520feac3cf626196af")!,
        URL(string: "https://pic2.99.co/v3/TcYeqatiRnWmUHr9tYkWi2?text=Susan+Wee&sampling=lanczos&version=1&height=600&width=800&mode=fill&quality=80&convert_if_png=true&signature=83641ad314f479c6c5a4d85246d6d33849246db1")!,
        URL(string: "https://pic2.99.co/v3/h9FZd2FyksGRfc75FoKSCQ?text=Susan+Wee&sampling=lanczos&version=1&height=600&width=800&mode=fill&quality=80&convert_if_png=true&signature=0d86f135b8511cac6b3aca928e2b219623766e98")!,
        URL(string: "https://pic2.99.co/v3/qs6MTzzCYgr4QjraxxPA79?text=Anne+Liu&sampling=lanczos&version=1&height=600&width=800&mode=fill&quality=80&convert_if_png=true&signature=2e0b9b3bdef66e3509e074995b4cd24b833b8506")!,
        URL(string: "https://pic2.99.co/v3/6HWaxhzqbJ8Bfd4D5ujdvN?text=Marc+PsManiam&sampling=lanczos&version=1&height=600&width=800&mode=fill&quality=80&convert_if_png=true&signature=681b5b1b86eed027bf53ff4e81afa998678e5c02")!,
