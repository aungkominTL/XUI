...
@ViewBuilder private func createTitle<S: StringProtocol>(_ text: S) -> Text {
    Text(text)
...
@ViewBuilder private func createSubtitle<S: StringProtocol>(_ text: S) -> Text {
    Text(text)
...
@ViewBuilder private func createImage<S: StringProtocol>(_ systemImage: S) -> some View {
    Image(systemName: systemImage as! String)
        .resizable()
        .scaledToFit()
}

public struct Toast<Title, Subtitle, Symbol>: View where Title : View, Subtitle : View, Symbol : View {
    
    var title: Title
    var subtitle: Subtitle
    var image: Symbol
    
    public init(title: Title, subtitle: Subtitle, image: Symbol) {
        self.title = title
...
public extension Toast where Title == Text, Subtitle == Text, Symbol: View {
...
public extension Toast where Title == Text, Subtitle == Text, Symbol == AnyView {
...
public extension Toast where Title == Text, Subtitle == EmptyView, Symbol == AnyView {
...
public extension Toast where Title == Text, Subtitle == Text, Symbol == EmptyView {
...
public extension Toast where Title == Text, Subtitle == EmptyView, Symbol == EmptyView {
