...
internal struct WaterfallLayout<Data, ID, Content>: View
      ...
      Content : View
{
    ...
    var lines: WaterfallLines
    var lineSpan: ((Data.Element) -> WaterfallLines)?
    var size: CGSize
        ...
        ZStack(alignment: .topLeading) {
            Group {
                if let content = content {
                    ...
                    WaterfallDynnamicViewBuilder(axis: axis,
                                              content: itemContent,
                                              data: data,
